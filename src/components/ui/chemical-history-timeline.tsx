...
export const ChemicalHistoryTimeline = ({
  ...
  const handleExport = () => {
    if (onExport) {
      ...
      const csvContent = [
        // Header
        ['Timestamp', 'Pool', 'Technician', 'Free Chlorine', 'Total Chlorine', 'pH', 'Alkalinity', 'Cyanuric Acid', 'Calcium', 'Temperature', 'Status'].join(','),
        // Data rows
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {/* Chemical Selection */}
          <Select value={selectedChemical} onValueChange={(value) => setSelectedChemical(value as ChemicalKey)}>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {trend.direction === 'stable' && <Minus className="h-4 w-4 text-gray-400" />}
              ...
              {showCompliance && chemicalStandard && (
                <div className="text-right">
                  <div className="text-sm text-gray-600">MAHC Range</div>
        ...
        {filteredData.length === 0 ? (
          <Card>
            <CardContent className="py-8 text-center">
              ...
              <h4 className="mt-4 text-lg font-medium text-gray-900">No readings found</h4>
          ...
          filteredData.map((reading, index) => {
            ...
            const validation = chemicalStandard ? validateChemical(currentValue, selectedChemical as ChemicalType) : null
            const previousReading = filteredData[index + 1]
            const valueChange = previousReading ? currentValue - previousReading.values[selectedChemical] : 0
            ...
            return (
              <Card
                ...
                className={cn(
                  ...
                  reading.status === 'emergency' && 'border-red-600 bg-red-50',
                  reading.status === 'critical' && 'border-red-400 bg-red-50',
                  reading.status === 'warning' && 'border-orange-400 bg-orange-50',
                  reading.status === 'compliant' && 'border-green-200 bg-green-50'
                )}
              >
                    ...
                    <div className="flex items-center gap-3">
                      <div
                        className={cn(
                          ...
                          reading.status === 'emergency' && 'bg-red-600 text-white',
                          reading.status === 'critical' && 'bg-red-500 text-white',
                          reading.status === 'warning' && 'bg-orange-500 text-white',
                    ...
                    <div className="flex items-center gap-3">
                      <div className="text-right">
                        <div className="flex items-center gap-2">
                          <span className={cn(
                            'text-lg font-bold',
                            validation?.status === 'emergency' && 'text-red-700',
                            validation?.status === 'critical' && 'text-red-600',
                            validation?.status === 'warning' && 'text-orange-600',
